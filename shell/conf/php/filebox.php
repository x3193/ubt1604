...
$mail = 'xcy6272003@126.com';//若有恶意登录，会发邮件到这个邮箱，前提是mail()函数可用！
...
function edit($fename) {
    ...
    if (file_exists($folder.$fename)) {
        ...
        //$contents=str_replace(chr(10),chr(10).'mmmm',$contents);
        //$contents=str_replace(chr(13),chr(13).'yyyyy',$contents);
...
function save($ncontent, $fename, $encode) {
    ...
    //----
		...
		//----
    if(file_put_contents($file, trim($ydata))) {
